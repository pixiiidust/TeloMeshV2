...
def render_fb_vs_wsjf_chart(metrics_data):
    ...
    if emphasize_critical:
        ...
        point_symbols = ["circle" if role == "critical" else "circle-open" for role in chart_data["percolation_role"]]
    else:
    ...
    **Understanding the chart:**
    ...
    Critical nodes (solid circles) have more impact on network integrity - changes to these pages will affect the overall user flow.
    """)
...
def render_regular_patterns(patterns_data):
    ...
    if pattern_list:
        ...
        # Display patterns in a container instead of an expander
